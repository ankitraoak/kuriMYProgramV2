...
from kurimypyrogram import __version__, __license__
from kurimypyrogram import enums
from kurimypyrogram import raw
from kurimypyrogram import utils
from kurimypyrogram.crypto import aes
from kurimypyrogram.errors import CDNFileHashMismatch
...
from kurimypyrogram.methods import Methods
from kurimypyrogram.session import Auth, Session
from kurimypyrogram.storage import Storage, FileStorage, MemoryStorage
from kurimypyrogram.types import User, TermsOfService
from kurimypyrogram.utils import ainput
...
class Client(Methods):
    """kurimypyrogram Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        app_version (``str``, *optional*):
            Application version.
            Defaults to "kurimypyrogram x.y.z".
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~kurimypyrogram.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where kurimypyrogram will store the session files.
        ...
        storage_engine (:obj:`~kurimypyrogram.storage.Storage`, *optional*):
        ...
        client_platform (:obj:`~kurimypyrogram.enums.ClientPlatform`, *optional*):
            The platform where this client is running.
            Defaults to 'other'

        init_connection_params (:obj:`~kurimypyrogram.raw.base.JSONValue`, *optional*):
            Additional initConnection parameters.
            For now, only the tz_offset field is supported, for specifying timezone offset in seconds.
    """

    APP_VERSION = f"kurimypyrogram {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to kurimypyrogram (version {__version__})")
        print(f"kurimypyrogram is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~kurimypyrogram.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.kurimypyrogram.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except kurimypyrogram.StopTransmission:
                raise

...
class MessageEntityType(AutoName):
    """Message entity type enumeration used in :obj:`~kurimypyrogram.types.MessageEntity`."""
    ...
    "``/start@kurimypyrogrambot``"

    URL = raw.types.MessageEntityUrl
    "``https://kurimypyrogram.org`` (see ``url``)"

    EMAIL = raw.types.MessageEntityEmail
    "``do-not-reply@kurimypyrogram.org``"

...
from kurimypyrogram.errors import PhoneMigrate, NetworkMigrate
from kurimypyrogram.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~kurimypyrogram.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.

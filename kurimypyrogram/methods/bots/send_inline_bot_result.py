...
from kurimypyrogram import raw, enums, types
...
class SendInlineBotResult:
    async def send_inline_bot_result(
        ...
        Bot results can be retrieved using :meth:`~kurimypyrogram.Client.get_inline_bot_results`
        ...
        Returns:
            :obj:`~kurimypyrogram.raw.base.Updates`: Currently, on success, a raw result is returned.

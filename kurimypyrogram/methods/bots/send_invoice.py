...
from kurimypyrogram import enums, raw, utils, types
...
class SendInvoice:
    async def send_invoice(
        ...
        Parameters:
            ...
            prices (List of :obj:`~kurimypyrogram.types.LabeledPrice`):
        ...
        Returns:
            :obj:`~kurimypyrogram.types.Message`: On success, the sent invoice message is returned.

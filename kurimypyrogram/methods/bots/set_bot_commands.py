...
class SetBotCommands:
    async def set_bot_commands(
        ...
        Parameters:
            commands (List of :obj:`~kurimypyrogram.types.BotCommand`):
                A list of bot commands.
                At most 100 commands can be specified.

            scope (:obj:`~kurimypyrogram.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~kurimypyrogram.types.BotCommandScopeDefault`.
        ...
        Example:
            .. code-block:: python
                ...
                from kurimypyrogram.types import BotCommand

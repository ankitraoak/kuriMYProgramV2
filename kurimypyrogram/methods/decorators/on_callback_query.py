...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~kurimypyrogram.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, kurimypyrogram.Client):
                self.add_handler(kurimypyrogram.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        kurimypyrogram.handlers.CallbackQueryHandler(func, self),

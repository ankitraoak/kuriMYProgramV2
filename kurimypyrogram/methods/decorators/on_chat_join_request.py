...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~kurimypyrogram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, kurimypyrogram.Client):
                self.add_handler(kurimypyrogram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        kurimypyrogram.handlers.ChatJoinRequestHandler(func, self),

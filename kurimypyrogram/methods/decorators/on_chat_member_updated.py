...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~kurimypyrogram.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, kurimypyrogram.Client):
                self.add_handler(kurimypyrogram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        kurimypyrogram.handlers.ChatMemberUpdatedHandler(func, self),

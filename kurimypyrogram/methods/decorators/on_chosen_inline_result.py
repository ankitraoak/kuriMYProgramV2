...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~kurimypyrogram.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, kurimypyrogram.Client):
                self.add_handler(kurimypyrogram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        kurimypyrogram.handlers.ChosenInlineResultHandler(func, self),

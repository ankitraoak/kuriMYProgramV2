...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~kurimypyrogram.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, kurimypyrogram.Client):
                self.add_handler(kurimypyrogram.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        kurimypyrogram.handlers.DeletedMessagesHandler(func, self),

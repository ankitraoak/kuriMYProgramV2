...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~kurimypyrogram.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, kurimypyrogram.Client):
                self.add_handler(kurimypyrogram.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        kurimypyrogram.handlers.EditedMessageHandler(func, self),

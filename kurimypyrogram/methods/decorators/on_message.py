...
class OnMessage:
    def on_message(
        ...
        :obj:`~kurimypyrogram.handlers.MessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, kurimypyrogram.Client):
                self.add_handler(kurimypyrogram.handlers.MessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        kurimypyrogram.handlers.MessageHandler(func, self),

...
class OnPoll:
    def on_poll(
        ...
        :obj:`~kurimypyrogram.handlers.PollHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, kurimypyrogram.Client):
                self.add_handler(kurimypyrogram.handlers.PollHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        kurimypyrogram.handlers.PollHandler(func, self),

...
class OnPreCheckoutQuery:
    def on_pre_checkout_query(
        ...
        :obj:`~kurimypyrogram.handlers.PreCheckoutQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, kurimypyrogram.Client):
                self.add_handler(kurimypyrogram.handlers.PreCheckoutQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        kurimypyrogram.handlers.PreCheckoutQueryHandler(func, self),

...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~kurimypyrogram.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, kurimypyrogram.Client):
                self.add_handler(kurimypyrogram.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        kurimypyrogram.handlers.UserStatusHandler(func, self),

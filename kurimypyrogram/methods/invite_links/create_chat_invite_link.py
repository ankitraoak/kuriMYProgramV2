...
class CreateChatInviteLink:
    async def create_chat_invite_link(
        ...
        The link can be revoked using the method :meth:`~kurimypyrogram.Client.revoke_chat_invite_link`.
        ...
        Returns:
            :obj:`~kurimypyrogram.types.ChatInviteLink`: On success, the new invite link is returned.

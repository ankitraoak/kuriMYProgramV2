...
from kurimypyrogram.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~kurimypyrogram.types.Message` | :obj:`~kurimypyrogram.types.Story` | ``str``):
        ...
        Returns:
            ...
            :meth:`~kurimypyrogram.Client.stop_transmission`, None is returned.

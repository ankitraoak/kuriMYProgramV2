...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~kurimypyrogram.Client.search_global_count`.
        ...
        Example:
            .. code-block:: python
                ...
                async for message in app.search_global("kurimypyrogram", limit=50):
                    print(message.text)

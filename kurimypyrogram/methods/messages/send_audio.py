...
from kurimypyrogram import StopTransmission, enums
from kurimypyrogram import raw
from kurimypyrogram import types
from kurimypyrogram import utils
from kurimypyrogram.errors import FilePartMissing
from kurimypyrogram.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~kurimypyrogram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~kurimypyrogram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~kurimypyrogram.Client.stop_transmission`, None is returned.

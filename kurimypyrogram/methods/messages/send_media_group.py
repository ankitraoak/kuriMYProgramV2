...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~kurimypyrogram.types.InputMediaPhoto`, :obj:`~kurimypyrogram.types.InputMediaVideo`, :obj:`~kurimypyrogram.types.InputMediaAudio` and :obj:`~kurimypyrogram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~kurimypyrogram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from kurimypyrogram.types import InputMediaPhoto, InputMediaVideo

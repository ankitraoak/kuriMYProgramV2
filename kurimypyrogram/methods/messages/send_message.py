...
from kurimypyrogram import raw, utils, enums
...
class SendMessage:
    async def send_message(
        ...
        Returns:
            :obj:`~kurimypyrogram.types.Message`: On success, the sent text message is returned.

        Example:
            .. code-block:: python

                # Simple example
                await app.send_message("me", "Message sent with **kurimypyrogram**!")

                # Disable web page previews
                await app.send_message("me", "https://docs.kurimypyrogram.org",
            ...
            .. code-block:: python
                ...
                from kurimypyrogram.types import (
                ...
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.kurimypyrogram.org")]
                        ]))
        """

...
async def compose(
    clients: List["kurimypyrogram.Client"],
    sequential: bool = False
):
    """Run multiple clients at once.

    This method can be used to run multiple clients at once and can be found directly in the ``kurimypyrogram`` package.

    If you want to run a single client, you can use Client's bound method :meth:`~kurimypyrogram.Client.run`.

    Parameters:
        clients (List of :obj:`~kurimypyrogram.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from kurimypyrogram import Client, compose

...
class Restart:
    async def restart(
        ...
        This method will first call :meth:`~kurimypyrogram.Client.stop` and then :meth:`~kurimypyrogram.Client.start` in a row in
        ...
        Returns:
            :obj:`~kurimypyrogram.Client`: The restarted client itself.

...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~kurimypyrogram.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~kurimypyrogram.Client.sign_in` or :meth:`~kurimypyrogram.Client.sign_up`).

        next_type (:obj:`~kurimypyrogram.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~kurimypyrogram.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~kurimypyrogram.Client.resend_code`.
    """

...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~kurimypyrogram.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~kurimypyrogram.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~kurimypyrogram.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~kurimypyrogram.types.CallbackGame`, *optional*):

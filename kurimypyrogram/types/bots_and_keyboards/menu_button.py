...
class MenuButton(Object):
    ...
    - :obj:`~kurimypyrogram.types.MenuButtonCommands`
    - :obj:`~kurimypyrogram.types.MenuButtonWebApp`
    - :obj:`~kurimypyrogram.types.MenuButtonDefault`

    If a menu button other than :obj:`~kurimypyrogram.types.MenuButtonDefault` is set for a private chat, then it is applied
    ...
    async def write(self, client: "kurimypyrogram.Client") -> "raw.base.BotMenuButton":

...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        chat_type (:obj:`~kurimypyrogram.enums.ChatType`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <kurimypyrogram.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~kurimypyrogram.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~kurimypyrogram.types.InlineQueryResult`):

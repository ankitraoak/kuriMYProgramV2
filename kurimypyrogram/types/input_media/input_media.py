...
class InputMedia(Object):
    ...
    - :obj:`~kurimypyrogram.types.InputMediaAnimation`
    - :obj:`~kurimypyrogram.types.InputMediaDocument`
    - :obj:`~kurimypyrogram.types.InputMediaAudio`
    - :obj:`~kurimypyrogram.types.InputMediaPhoto`
    - :obj:`~kurimypyrogram.types.InputMediaVideo`
    """

...
from kurimypyrogram import types, enums, raw, utils
...
class BusinessMessage(Object):
    ...
    Parameters:
        ...
        recipients (List of :obj:`~kurimypyrogram.types.User`, *optional*):
            Recipients of the message.

        schedule (:obj:`~kurimypyrogram.enums.BusinessSchedule`, *optional*):

...
from kurimypyrogram import types, raw, utils
...
class ForumTopic(Object):
    ...
    Parameters:
        ...
        creator (:obj:`~kurimypyrogram.types.Chat`, *optional*):
            Topic creator.

        top_message (:obj:`~kurimypyrogram.types.Message`, *optional*):
    ...
    @staticmethod
    def _parse(client: "kurimypyrogram.Client", forum_topic: "raw.types.ForumTopic", messages: dict = {},  users: dict = {}, chats: dict = {}) -> "ForumTopic":

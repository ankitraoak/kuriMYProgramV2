...
from kurimypyrogram import errors, raw, utils
...
class GiveawayResult(Object):
    ...
    Parameters:
        chat (List of :obj:`~kurimypyrogram.types.Chat`):
        ...
        winners (List of :obj:`~kurimypyrogram.types.User`):
        ...
        launch_message (:obj:`~kurimypyrogram.types.Message`, *optional*):

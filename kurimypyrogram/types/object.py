...
class Object:
    def __init__(self, client: "kurimypyrogram.Client" = None):
        self._client = client

    def bind(self, client: "kurimypyrogram.Client"):
        """Bind a Client instance to this and to all nested kurimypyrogram objects.

        Parameters:
            client (:obj:`~kurimypyrogram.types.Client`):
                The Client instance to bind this object with. Useful to re-enable bound methods after serializing and
                deserializing kurimypyrogram objects with ``repr`` and ``eval``.
        """
        self._client = client
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/kurimypyrogramchat/167281
    ...
    def __repr__(self) -> str:
        return "kurimypyrogram.types.{}({})".format(

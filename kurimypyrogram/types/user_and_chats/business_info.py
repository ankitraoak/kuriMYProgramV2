...
from kurimypyrogram import types, raw
...
class BusinessInfo(Object):
    ...
    Parameters:
        ...
        greeting_message (:obj:`~kurimypyrogram.types.BusinessMessage`, *optional*):
            Greeting message of the business.

        away_message (:obj:`~kurimypyrogram.types.BusinessMessage`, *optional*):
            Away message of the business.

        working_hours (:obj:`~kurimypyrogram.types.BusinessWorkingHours`, *optional*):

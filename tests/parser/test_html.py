...
from kurimypyrogram.parser.html import HTML
...
def test_html_unparse_underline():
    ...
    text = "underline"
    entities = kurimypyrogram.types.List(
        [kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.UNDERLINE, offset=0, length=9)])
...
def test_html_unparse_url():
    expected = '<a href="https://kurimypyrogram.org/">URL</a>'
    text = "URL"
...
def test_html_unparse_blockquote():
    ...
    entities = kurimypyrogram.types.List([kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.BLOCKQUOTE, offset=0,
                                                                 length=10)])
...
def test_html_unparse_mixed():
    ...
    entities = kurimypyrogram.types.List(
        [kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.BOLD, offset=0, length=14),
         kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.ITALIC, offset=7, length=7),
         kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.UNDERLINE, offset=10, length=4),
         kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.UNDERLINE, offset=14, length=9),
         kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.ITALIC, offset=14, length=9),
         kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.UNDERLINE, offset=23, length=10),
         kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.STRIKETHROUGH, offset=30, length=3),
         kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.STRIKETHROUGH, offset=33, length=10),
         kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.SPOILER, offset=38, length=5),
         kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.SPOILER, offset=43, length=10),
         kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.CODE, offset=57, length=10)])
...
def test_html_unparse_escaped():
    ...
    text = "<b>bold</b>"
    entities = kurimypyrogram.types.List(
        [kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.BOLD, offset=0, length=11)])
...
def test_html_unparse_escaped_nested():
    ...
    entities = kurimypyrogram.types.List(
        [kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.BOLD, offset=0, length=33),
         kurimypyrogram.types.MessageEntity(type=kurimypyrogram.enums.MessageEntityType.UNDERLINE, offset=8, length=16)])
